...
# Add credentials to default section so devs can test AWS integration locally
# This is the 3rd location queried by AWS SDK Default Credentials Provider 
...
os.environ["AWS_KEY_ID"] = token.credentials.access_key
print token.credentials.access_key
